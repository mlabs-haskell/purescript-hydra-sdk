...
let
  inputs = {
    ...
    "aeson" = pkgs.stdenv.mkDerivation {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "e7bfc24a941e1d73de88de3f4a034e1da33cc8ae";
          sha256 = "1snywfzdxbmh7iqiaknfd9yj0hpaydf9ss3a9sjlwpjkij52xm34";
        };
        phases = "installPhase";
    ...
    "cardano-hd-wallet" = pkgs.stdenv.mkDerivation {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "32ef8e227fa08901319e66359ada678aed5cb988";
          sha256 = "17fvlgyqyl4wsxh0bhghfn7vq3yxnk7zl1ks8lzhgz971rfl0qi8";
        };
        phases = "installPhase";
        installPhase = "ln -s $src $out";
      };
    ...
    "cardano-ogmios-mempool" = pkgs.stdenv.mkDerivation {
        name = "cardano-ogmios-mempool";
        version = "v1.1.0";
        src = pkgs.fetchgit {
          url = "https://github.com/mlabs-haskell/purescript-cardano-ogmios-mempool";
          rev = "c382bcc35eeceb8a55744f3e62867f9bd690b85b";
    ...
    "codec-aeson" = pkgs.stdenv.mkDerivation {
        name = "codec-aeson";
    ...
    "errors" = pkgs.stdenv.mkDerivation {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "670485beb1e026f77d52ca58ce10c145d96c11ba";
          sha256 = "1r2p5yb18rh89gl24n8ljki7ch2n2dii22p7qwvqbyw264m2v6c7";
        };
        phases = "installPhase";
        installPhase = "ln -s $src $out";
      };
  ...
  # hydra-sdk is a Local package in (Local "./../..")
    ...
    "uplc-apply-args" = pkgs.stdenv.mkDerivation {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "fa886ba1f5c0441c33c4f89d7d29235ce82080ce";
          sha256 = "0qwisbfz1mjaqq4hf7vv6hkq54y9523zwxvnzcqz6k544cq02zi6";
        };
        phases = "installPhase";
        installPhase = "ln -s $src $out";
      };
